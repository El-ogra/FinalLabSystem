...
public partial class ChangeSensitivePasswordDialog : Window
{
    public ChangeSensitivePasswordDialog()
    {
        InitializeComponent();
    ...
    {
        set => CurrentPasswordLabel.Text = $"كلمة المرور الحالية لـ {value}:";
    }
    ...
    private void OK_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (!IsFirstTime && string.IsNullOrWhiteSpace(CurrentPasswordBox.Password))
        {
        ...
        CurrentPassword = IsFirstTime ? null : CurrentPasswordBox.Password;
