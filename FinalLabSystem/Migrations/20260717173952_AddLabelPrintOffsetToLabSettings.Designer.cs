...
namespace FinalLabSystem.Migrations
{
    ...
    [Migration("20260717173952_AddLabelPrintOffsetToLabSettings")]
    partial class AddLabelPrintOffsetToLabSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalLabSystem.Models.LabSetting", b =>
                {
                    ...
                    b.Property<bool>("AutoPrintReceiptAfterSave")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("DefaultBackupPath")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("default_backup_path");
                    ...
                    b.Property<double>("LabelPrintOffsetXmm")
                        .HasColumnType("float");

                    b.Property<double>("LabelPrintOffsetYmm")
                        .HasColumnType("float");
                    ...
                    b.Property<bool>("ShowTestBreakdownInReceipt")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FinalLabSystem.Models.PatientBarcode", b =>
                {
                    b.Property<int>("PatientBarcodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PatientBarcodeId"));
                    ...
                    b.Property<int>("SortOrdinal")
                        .HasColumnType("int");

                    b.Property<int?>("VisitId")
                        .HasColumnType("int");

                    b.HasKey("PatientBarcodeId");
                    ...
                    b.ToTable("PatientBarcode", (string)null);
                });
            ...
            modelBuilder.Entity("FinalLabSystem.Models.ReceiptPrintLog", b =>
                {
                    ...
                    b.Property<bool>("ShowBreakdown")
                        .HasColumnType("bit")
                        .HasColumnName("show_breakdown");
                    ...
                    b.HasKey("LogId")
                        .HasName("PK_ReceiptPrintLog");

                    b.HasIndex("StaffId");

                    b.HasIndex(new[] { "PrintedAt" }, "IX_ReceiptPrintLog_PrintedAt");

                    b.HasIndex(new[] { "VisitId" }, "IX_ReceiptPrintLog_VisitId");

                    b.ToTable("ReceiptPrintLog", (string)null);
                });
            ...
            modelBuilder.Entity("FinalLabSystem.Models.ReferralSource", b =>
                {
                    ...
                    b.Property<string>("Category")
                        ...
                        .HasDefaultValue("ReferringDoctor")
            ...
            modelBuilder.Entity("FinalLabSystem.Models.SensitiveScreenPassword", b =>
                {
                    b.Property<int>("SensitiveScreenPasswordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("sensitive_screen_password_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SensitiveScreenPasswordId"));
                    ...
                    b.HasKey("SensitiveScreenPasswordId")
                    ...
                    b.ToTable("SensitiveScreenPassword", (string)null);
                });
                    ...
                    b.ToTable("TestResult", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_TestResult_NumericSync", "[result_numeric] IS NULL OR [result_value] IS NOT NULL");
                        });
            ...
            modelBuilder.Entity("FinalLabSystem.Models.TestType", b =>
                {
                    ...
                    b.Property<decimal>("LabToLabDefaultPrice")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 2)")
                        .HasDefaultValue(0m)
                    ...
                    b.Property<decimal>("PatientDefaultPrice")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18, 2)")
                        .HasDefaultValue(0m)
            ...
            modelBuilder.Entity("FinalLabSystem.Models.TubeMaterial", b =>
                {
                    b.Property<int>("TubeMaterialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("tube_material_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TubeMaterialId"));
                    ...
                    b.Property<string>("MaterialNameAr")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
                        .HasColumnName("material_name_ar");
                    ...
                    b.HasKey("TubeMaterialId");

                    b.ToTable("TubeMaterial", (string)null);
                });

            modelBuilder.Entity("FinalLabSystem.Models.Unit", b =>
                {
            ...
            modelBuilder.Entity("FinalLabSystem.Models.SensitiveScreenPassword", b =>
                {
                    b.HasOne("FinalLabSystem.Models.Staff", "LastUpdatedByNavigation")
                        .WithMany("SensitiveScreenPasswords")
                        .HasForeignKey("LastUpdatedBy")
            ...
            modelBuilder.Entity("FinalLabSystem.Models.VisitTest", b =>
                {
                    ...
                    b.HasOne("FinalLabSystem.Models.Staff", "ExportedByNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("FinalLabSystem.Models.Staff", b =>
                {
                    ...
                    b.Navigation("SensitiveScreenPasswords");
