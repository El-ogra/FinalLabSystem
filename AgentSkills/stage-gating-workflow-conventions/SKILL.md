...
description: نمط "Stage-Gating" الفعلي المطبق في FinalLabSystem — تحكم صارم في تدفق حالات العينة/الطلب عبر مراحل اعتماد معتمدة. يستند إلى Infrastructure/ResultStageRules.cs و Models/Enums/TestStage.cs و Models/Enums/ResultValidationStatus.cs. يشرح كيف تُطبِّق gating لأي اختبار، كيف تربط UI بقدرة الطور، كيف تكتب قواعد جديدة، وكيف تتعامل مع الاستثناءات (External Labs، الإلغاء).
---
