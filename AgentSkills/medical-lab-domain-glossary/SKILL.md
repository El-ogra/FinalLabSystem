...
description: قاموس مصطلحات دقيق مبني على كيانات FinalLabSystem الحقيقية (Patient, Visit, VisitTest, TestResult, TestType, TestComponent, SampleTube, NormalRange, VisitCharge, Payment, إلخ). يربط كل مصطلح بـ entity/DTO الفعلي، يحدد الـ Arabic مقابل الـ English، ويحدد قواعد العمل (business rules) المطبقة في الكود. عنصر إلزامي لأي agent يكتب خدمات أو ViewModels أو تقارير جديدة في هذا المشروع.
---
