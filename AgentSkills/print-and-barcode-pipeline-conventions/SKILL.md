...
description: نمط طباعة الملصقات (Tube Labels) والتقارير (Patient Reports) المطبَّق فعلياً في FinalLabSystem عبر ZXing.Net + FlowDocument. يشرح كيف تولّد باركود، كيف تصمم ملصق، كيف تبني تقرير FlowDocument، كيف تتعامل مع طابعة معينة، وكيفية توسيع النمط لأي تقرير أو ملصق جديد. يستند إلى Infrastructure/Barcoding/* و Services/Implementations/WpfLabelPrintService.cs و WpfFlowDocumentPrintService.cs.
---
