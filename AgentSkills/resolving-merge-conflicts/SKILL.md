...
description: "حل تعارضات git merge/rebase في FinalLabSystem. يوفر خطوات واضحة وأمثلة واقعية من المشروع (تعارض في Audit logic، ViewModels، Migrations، DI Registration)."
metadata:
  ...
  common-conflict-areas:
    ...
    - di-and-navigation-registration
---
