---
name: implement
description: "Implement a piece of work based on a PRD or set of issues. Tailored to FinalLabSystem — reads PRD, picks a slice from the Work Plan, follows the previous Handoff, executes with TDD, validates the gate, then produces the next Handoff."
